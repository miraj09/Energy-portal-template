...
// Utility class for Info button
const InfoButton = ({ children = "Info", ...props }) => (
  <button
    className="bg-[#2986cc] text-white rounded px-3 py-1 text-xs font-medium hover:bg-[#1761a0] transition-colors cursor-pointer"
    {...props}
  >
    {children}
  </button>
