...
}export async function getTpiDocuments(endpoint: string = "/api/v1/auth/web/utility/tpi-documents/"): Promise<{success: boolean; data?: unknown; message?: string; errors?: unknown;}> { return getDropdown(endpoint); }
