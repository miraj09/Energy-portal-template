...
}export async function getTpiFolderDetails(endpoint: string = "/api/v1/auth/web/utility/tpi-folders/1/"): Promise<{success: boolean; data?: unknown; message?: string; errors?: unknown;}> { return getDropdown(endpoint); }
